...
//        Toast.makeText(mContext, "当前商品数=="+value, Toast.LENGTH_SHORT).show();
    ...
    private NumberAddSubView.OnNumberChangeListener onNumberChangeListener;

    /**
     * 设置数量变化的监听
     * @param onNumberChangeListener
     */
    public void setOnNumberChangeListener(NumberAddSubView.OnNumberChangeListener onNumberChangeListener) {
